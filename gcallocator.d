...
*/
module std.allocators.gcallocator;

import core.memory;
import std.array, std.traits, std.typetuple;  
...
struct GCAllocator {
    ...
    This does not affect memory allocated by $(D newArray), $(D array) or
    $(D uninitializedArray) since these functions have type information
    available.  The default is $(D true).
    */
